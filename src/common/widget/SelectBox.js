function SelectBox() {
    ...
    */
    ...
    this.bind("click", function() {
        ...
        this.popupContainer.setMinWidth(this.statusItem.offsetWidth);
        this.popupContainer.show(this.statusBox, "left-inside", "bottom", 0, 5, "autoFlip");
        setTimeout(function() {
        ...
        this.bind("click", function(event) {
            ...
            if (this.multipleSelect == true &&
                ...
                if (event.target === optionAll) {
                    ...
                    if (optionAll) {
                        var c = this.countSelectedOption();
                        optionAll.checked = c == this.options.length - 1;
                    }
                }
...
SelectBox.prototype._setSelectedStatus = function() {
    ...
    if (this.noneSelectionText && (!selectedText || selectedText.length == 0)) {
        status = this.noneSelectionText;
    }
